...
coverImage: ../../../images/pontevedra-rua-oliva.jpg
...
These days, between the 19th and 21st of February, has taken place the learning activity titled "**An Introduction to the Joint Modeling of Longitudinal and Survival Data, with Applications in R**" organized by the Interdisciplinary Group of Biostatistics ([ICBUSC](http://icbusc.com/)), directed by Professor Carmen Cadarso-Suárez, from the [University of Santiago de Compostela](http://www.usc.es/en/index.html). 
...
The training activity has been taught by the professor [Dimitris Rizopoulos](http://www.drizopoulos.com/) of the Erasmus University Medical Center in Rotterdam, specialist in [joint-modeling techniques](http://www.drizopoulos.com/courses/EMC/ESP72.pdf). Professor Rizopoulos is the author of a [book on joint modeling](https://www.crcpress.com/Joint-Models-for-Longitudinal-and-Time-to-Event-Data-With-Applications/Rizopoulos/p/book/9781439872864), as well as numerous publications and two related R packages: [JM](https://cran.r-project.org/web/packages/JM/index.html) and [JMbayes](https://cran.r-project.org/web/packages/JMbayes/index.html). 
...
The applicability of these models has been illustrated through the JM and JMBayes R packages (by D Rizopoulos), as well as the packages [joineR](https://cran.r-project.org/web/packages/joineR/index.html) (by Philipson et al.), and [lcmm](https://cran.r-project.org/web/packages/lcmm/index.html) (by Proust-Lima et al.) 
...
Also, the [JM](https://cran.r-project.org/web/packages/JM/index.html) package has functions for *discrimination* and *callibration*, (of a single marker and between models): *sensitivity* & *specificity*, *time-dependent ROCs* and *AUC*.  
