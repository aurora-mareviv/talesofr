...
Tweets refer also to this great post: **[Observed power, and what to do if your editor asks for post-hoc power analyses](http://daniellakens.blogspot.com/2014/12/observed-power-and-what-to-do-if-your.html){target="_blank"}**, written by [Dani&euml;l Lakens](https://twitter.com/lakens){target="_blank"} in which this issue is discussed. 
...
My two cents to this discussion abut **post-hoc power** come below in the form of a small R tutorial. It demonstrates, using the rationale in the paper, how it *doesn't make sense* to get power calculations after hypothesis testing. 
