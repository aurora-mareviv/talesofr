...
And [here](https://github.com/aurora-mareviv/aurora-mareviv.github.io/blob/master/static/js/myjs.js){target="_blank"} is the javascript function that you can copy into `/static/js/myjs.js`:
