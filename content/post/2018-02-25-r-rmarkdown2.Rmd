...
This is an updated blog post from the previous version: [R Blogdown Setup in GiHub](https://aurora-mareviv.github.io/talesofr/2017/08/r-blogdown-setup-in-github/). 
...
The [Hugo install page](https://gohugo.io/getting-started/installing/) is a good place to start!
...
Further customisation can be done thanks to the incredible user documentation for the [hugo-tranquilpeak-theme](https://github.com/kakawait/hugo-tranquilpeak-theme/blob/master/docs/user.md)
